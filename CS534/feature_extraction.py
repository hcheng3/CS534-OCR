...
from skimage import filter as ff, io
...
class feature_extraction(object):
    ...
    def combine_all(self):
        return np.concatenate((self.profiling(), np.array(self.density()),np.array(self.direction())))
...
#asd = feature_extraction("trainningdata/6-0.bmp")
